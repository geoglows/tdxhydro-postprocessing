...
inputs_path = 'C:\\Users\\lrr43\\Desktop\\Lab\\Test'
outputs_path = 'C:\\Users\\lrr43\\Desktop\\Lab\\Test_Output'
...
if __name__ == '__main__':
    ...
    for streams_gpq, basins_gpq in gis_iterable:
        ...
        try:
            ...
            # make a simplified river network for investigating the clusters
            if not os.path.exists(os.path.join(save_dir, f'vpus_{region_number}.gpkg')):
                rp.inputs.make_quick_visuals(save_dir, streams_gpq)
