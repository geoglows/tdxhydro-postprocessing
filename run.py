...
from RAPIDprep import dissolve_streams, dissolve_basins, prepare_rapid_inputs, make_weight_table, is_valid_rapid_dir
...
if __name__ == '__main__':
    ...
    regions_to_skip = [d for d in glob.glob(os.path.join(outputs_path, '*')) if is_valid_rapid_dir(d)]
